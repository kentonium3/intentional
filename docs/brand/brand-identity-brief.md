...
Define the visual and experiential identity of **Intentional** to ensure consistency between voice, tone, and design across all client- and market-facing materials. This brief translates the Values & Principles into visual choices so design consistently expresses clarity, trust, excellence, empathy, and purpose.
...
| **Keywords** | Trust, Alignment, Clarity, Excellence, Empathy, Integrity |
| **Emotional Goal** | Convey calm confidence, expertise, and humanity, reassurance through honesty, simplicity that signals confidence |
...
Whitespace equals honesty — avoid unnecessary decoration.
Prioritize legibility and hierarchy over ornamentation.
Sans-serif primary for clarity; optional serif accent for warmth and calm.
...
- Avoid ornamentation; visual restraint signals confidence.
...
- [Intentional Values & Principles](<intentional-values-and-principles.md>) — Core values and brand principles
- [Brand Voice & Tone](<brand-voice-and-tone.md>) — How Intentional sounds in writing
- [Consulting Core](../strategy/intentional-consulting-core.md) — What Intentional does
- [Intentional Index Explained](../strategy/intentional-index-explained.md) — How Intentional measures alignment
